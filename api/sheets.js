...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const reqs1 = [
      ...
      rowH(s1,3,22),
      // KPI values
      rep(s1,4,5,0,2, fmt(C.AZUL_C,C.AZUL,true,24,false,false)),
      rep(s1,4,5,2,4, fmt(C.VERDE_C,C.VERDE,true,24,false,false)),
      rep(s1,4,5,4,6, fmt(C.MORADO_C,C.MORADO,true,24,false,false)),
      rep(s1,4,5,6,8, fmt(C.TEAL_C,C.TEAL,true,24,false,false)),
